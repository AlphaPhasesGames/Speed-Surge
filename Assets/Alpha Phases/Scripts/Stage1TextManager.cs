...
namespace SSGFE.Alpha.Phases.Games
{
    public class Stage1TextManager : MonoBehaviour
    {
        ...
        private void HandleArrayPosActions()
        {
            switch (arrayPos)
            {
                case 0: SpeakText("stage1MissionText1"); break;
                case 1: SpeakText("stage1MissionText2"); break;
                ...
                case 5:
                    ...
                    break;
                case 6: SpeakText("stage1MissionText7"); break;
                ...
                case 11: SpeakText("stage1MissionText12"); break;
                case 12:
