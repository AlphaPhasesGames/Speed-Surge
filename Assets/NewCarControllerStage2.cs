...
{
    public class NewCarControllerStage2 : MonoBehaviour
    {
        ...
        public float pitchLimitMin = 0.3f;
        ...
        public bool volume1Once;
        public bool volume2Once;
        public bool volume3Once;
        public bool volume4Once;
        public bool volume5Once;
        public bool volume6Once;
            ...
            if (isCarActive)
            {
                ...
                if (Input.GetKey(KeyCode.W) || Input.GetKey(KeyCode.UpArrow)) // if W is pressed
                {
                    ...
                    if (engineAudioSelected)
                    {
                        ...
                        if (engineIdle.pitch > pitchLimitMax)
                        {
